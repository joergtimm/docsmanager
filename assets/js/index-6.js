...
export function audience(myVarVal) {
...
export function Sessions(myVarVal) {
  chart.updateOptions({
    colors: [
      "rgba(" + myVarVal + ", 1)",
      "rgba(96,165,250, 1)",
...
var element = document.getElementById("audience");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [
...
export function audienceOverview(myVarVal) {
  chart.updateOptions({
    colors: ["rgb(" + myVarVal + ")", "rgb(203,213,225)"],
  });
}

var element = document.getElementById("session2");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [40, 40, 20],
...
export function session2(myVarVal) {
  chart.updateOptions({
