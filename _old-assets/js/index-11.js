...
var element = document.getElementById("totalInvested");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [
...
var element = document.getElementById("totalInvestments");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [
...
// Total Returns Chart
var element = document.getElementById("totalReturns");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [
...
// Returns Rate Chart
var element = document.getElementById("returnsRate");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [
