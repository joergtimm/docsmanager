var element = document.getElementById("subscriptionOverview");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [
...
var element = document.getElementById("candidates-chart");
  if (element !== null) {
    element.innerHTML = "";
  var options1 = {
    series: [1754, 1234],
...
var chart1 = new ApexCharts(document.querySelector("#candidates-chart"), options1);
chart1.render();
}

export function subOverview(myVarVal) {
  chart.updateOptions({
    colors: ["rgb(" + myVarVal + ")", "#d1dae5","rgb(96, 165 ,250)"],
  });
}
export function Candidates(myVarVal) {
