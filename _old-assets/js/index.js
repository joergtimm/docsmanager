...
var element = document.getElementById("salesOverview");
if (element !== null) {
  element.innerHTML = "";
var options = {
  series: [
...
if (myCanvas) {
  ...
  var myChart = Chart.getChart("sales-donut");
...
/*  sales overview chart */
export function salesOverview(myVarVal) {
  chart.updateOptions({
    colors: ["rgb(" + myVarVal + ")", "rgb(203,213,225)"],
  });
}

export function visitorschart(myVarVal) {
