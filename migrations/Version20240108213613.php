 ...
 */
final class Version20240108213613 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mandnat ADD custom_nr VARCHAR(255) DEFAULT NULL, ADD status VARCHAR(50) NOT NULL, ADD adresse LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', ADD emails LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mandnat DROP custom_nr, DROP status, DROP adresse, DROP emails');
    }
}
