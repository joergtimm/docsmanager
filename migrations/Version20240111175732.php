 ...
 */
final class Version20240111175732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video_actor (video_id INT NOT NULL, actor_id INT NOT NULL, INDEX IDX_CB175F5B29C1004E (video_id), INDEX IDX_CB175F5B10DAF24A (actor_id), PRIMARY KEY(video_id, actor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
