 ...
 */
final class Version20240212221707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE data_view ADD page INT DEFAULT NULL, ADD query VARCHAR(255) DEFAULT NULL, ADD sort VARCHAR(255) DEFAULT NULL, ADD sort_direction VARCHAR(255) DEFAULT NULL, ADD view_mode VARCHAR(255) DEFAULT NULL, ADD list_items INT DEFAULT NULL, ADD grid_items INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE data_view DROP page, DROP query, DROP sort, DROP sort_direction, DROP view_mode, DROP list_items, DROP grid_items');
    }
}
